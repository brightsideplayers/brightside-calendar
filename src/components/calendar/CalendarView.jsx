      ...
      item.type === "task"
        ? {
            ...
            description:
              editDraft.caption,
            assignedTo:
              editDraft.assignedTo,
            taskStatus:
              editDraft.taskStatus,
            date:
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-white/50 mt-2">
              Schedule your productions,
              social posts & rehearsal
              tasks.
            </p>
          </div>
                    ...
                    <div className="grid gap-1.5 pt-9">
                      {items
                        ...
                        .map((item, idx) => (
                          <div
                            key={idx}
                            className={`rounded-lg px-2 py-1 text-[11px] md:text-xs truncate border ${
                              item.type === "task"
                                ...
                                : item.platform ===
                                  "TikTok"
                                ? "bg-gradient-to-r from-[#111111] to-cyan-500/20 border-cyan-300/20 text-cyan-100 shadow-[0_0_12px_rgba(34,211,238,0.12)]"
                                : item.platform ===
                                  "YouTube"
            ...
            <div className="grid gap-4 pb-6">
              {selectedDayItems.length > 0 ? (
                      ...
                      {isEditing ? (
                        <div className="grid gap-3">
                          ...
                          <textarea
                            ...
                            className="min-h-[160px] rounded-[1.5rem] bg-black/30 border border-white/10 p-4 text-white"
                          />
                ...
                <div className="rounded-[2rem] border border-dashed border-white/10 bg-white/[0.03] p-12 text-center grid gap-5">
                  ...
                  <p className="text-white/50 mt-2">
                    There are no scheduled posts or
                    tasks for this day.
                  </p>
