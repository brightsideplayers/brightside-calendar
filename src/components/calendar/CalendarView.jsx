              ...
              (day, index) => {
                ...
                return (
                  <button
                    ...
                    className="relative min-h-[120px] md:min-h-[150px] p-3 border-r border-b border-white/5 text-left hover:bg-cyan-400/5 transition-all"
                  >
                    {day && (
                      <>
                        {/* QUICK ADD BUTTON */}
                        <button
                          ...
                          className="absolute top-2 right-2 w-7 h-7 rounded-full bg-cyan-400 text-black text-sm font-black hover:scale-110 transition-all z-10"
                        >
                          +
                        </button>
